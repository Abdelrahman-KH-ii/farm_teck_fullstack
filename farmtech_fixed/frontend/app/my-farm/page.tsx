                      ...
                      {activeField && (
                        <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-border">
                          <h3 className="font-semibold mb-2">
                            {activeField.crop_type.charAt(0).toUpperCase() + activeField.crop_type.slice(1)} Field
                          </h3>
                        ...
                        fields.map((field) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                <h4 className="font-semibold text-foreground capitalize">{field.crop_type}</h4>
                                <p className="text-sm text-muted-foreground">{field.soil_type || "Unknown soil"}</p>
                              </div>
                              <Badge
              ...
              <Card className="mt-6 bg-card border-border">
                <CardHeader className={`bg-gradient-to-r ${activeField.status === "healthy" ? "from-accent/10 to-primary/10" : "from-orange-500/10 to-red-500/10"}`}>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <span className="capitalize">{activeField.crop_type}</span> Field — {L.detailedInfo}
                  </CardTitle>
                </CardHeader>
                <CardContent className="pt-4">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-lg hover:border-primary/50 transition-colors">
                      ...
                      <p className="font-bold text-lg text-foreground capitalize">{activeField.crop_type}</p>
                    </div>
            ...
            {!loading && !error && farms.length > 0 && (
              <Card className="mt-6 bg-card border-border">
                <CardHeader>
                  ...
                  <CardDescription>{farms.length} farm(s) registered</CardDescription>
                </CardHeader>
                <CardContent>
