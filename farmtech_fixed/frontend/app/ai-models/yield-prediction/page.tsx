...
export default function YieldPredictionPage() {
  ...
  // Static fallback predictions (shown before AI call)
  const predictions = {
  ...
  const currentPrediction = predictions[formData.cropType as keyof typeof predictions]
              ...
              {aiResult && (
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/30 rounded-lg p-6 mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="bg-background/60 rounded-xl p-5 text-center border border-border">
                      <p className="text-sm text-muted-foreground mb-1">Crop</p>
                      <p className="text-2xl font-bold text-foreground capitalize">{aiResult.crop}</p>
                    </div>
                    <div className="bg-background/60 rounded-xl p-5 text-center border border-primary/40">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">{aiResult.unit}</p>
                    </div>
                    <div className="bg-background/60 rounded-xl p-5 text-center border border-border">
                      <p className="text-sm text-muted-foreground mb-1">Location</p>
                      <p className="text-lg font-bold text-foreground">{formData.lat}°, {formData.lon}°</p>
                      <p className="text-xs text-muted-foreground mt-1">Year: {formData.year}</p>
                    </div>
                  </div>
